...
import 'dart:convert';
import 'package:projek_uas/user/databuku/detail.dart';

class databukuuser extends StatefulWidget {
  @override
  _databukuuserState createState() => _databukuuserState();
}

class _databukuuserState extends State<databukuuser> {
        ...
        return Container(
          ...
          child: new GestureDetector(
            onTap: () => Navigator.of(context).push(new MaterialPageRoute(
                ...
                new Detailbukuuser(list: list, index: i))),
            child: new Card(
              child: new ListTile(
